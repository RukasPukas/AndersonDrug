  ...
  $("#calculateDosage").on("click", function () {
    ...
    if (protocolSelected === "Intubation") {
      ...
      if (assistedIntubationDose > 200) {
        ...
        console.log(
          "Assisted intubation dose capped at 200:",
          assistedIntubationDose
        );
      }
      ...
      $("#result")
        ...
        <p><strong>Suggested Dosage IV/IO:</strong> ${assistedIntubationDose.toFixed(
          2
        )}mg
        <br>
        ...
        <br>
        <br>
        <strong>Suggested Volume:</strong> ${assistedIntubationVolume.toFixed(
          2
        )}ml
        <br><small>(For Concentrations of 50mg per ml)
        <br>
